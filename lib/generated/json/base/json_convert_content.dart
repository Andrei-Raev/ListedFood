...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CheckEditListElementDataEntity>[] is M) {
      return data
          .map<CheckEditListElementDataEntity>((
          Map<String, dynamic> e) => CheckEditListElementDataEntity.fromJson(e))
          .toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CheckEditListElementDataEntity).toString(): CheckEditListElementDataEntity
        .fromJson,
  };
